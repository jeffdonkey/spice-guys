...
const PrivateScreen = ({ history }) => { // Destructure the history prop from the props object; used for redirecting the user
    ...
    const logoutHandler = () => { // Function that will be called when the logout button is clicked
        localStorage.removeItem("authToken");
        history.push("/login");
    };
